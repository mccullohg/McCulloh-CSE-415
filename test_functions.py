...
class TestA1Functions(unittest.TestCase):
    ...
    def test_is_multiple_of_11(self):
        """Provided tests for is_multiple_of_11 in starter code."""
        test_cases = [
            (0, True), (11, True), (1, False), (22, True), (-1, False),
            (-11, True),
        ]
        self._test_function_on_cases(a1.is_multiple_of_11, test_cases)
    ...
    def test_make_quartic_evaluator(self):
        """Provided test for make_quartic_evaluator: x^3+1 ."""
        fn = a1.make_quartic_evaluator(0, 1, 0, 0, 1)
        assert isinstance(fn, type(lambda i: i)), (
            "Value returned from make_quartic_evaluator(0, 1, 0, 0, 1) "
            "is not a function!")
        ...
        assert fn.__name__ == "<lambda>", (
            "Function returned from make_quartic_evaluator(0, 1, 0, 0, 1) "
            "is not a lambda!")
